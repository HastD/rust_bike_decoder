...
A second executable used for analyzing absorbing sets will be generated at `target/release/absorbing`. This program has three subcommands: `filter`, `enumerate`, and `sample`.
